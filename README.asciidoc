== db-migration-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The db-migration-addon addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>db-migration-addon</artifactId>
