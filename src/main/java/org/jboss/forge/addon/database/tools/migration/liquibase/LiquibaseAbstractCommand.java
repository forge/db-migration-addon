...
public abstract class LiquibaseAbstractCommand
{
   ...
   private AutoCloseableLiquibase openLiquibase(final DataSourceFactory dataSourceFactory, final Properties properties,
            String migrationFile)
            throws SQLException, LiquibaseException
   {
      final ManagedDataSource dataSource = dataSourceFactory.buildSingleConnectionPool(properties);
      final AutoCloseableLiquibase autoCloseableLiquibase = migrationFile != null ? new AutoCloseableLiquibase(
               dataSource, migrationFile) : new AutoCloseableLiquibase(dataSource);
